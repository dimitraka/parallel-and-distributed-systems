/*!
  \file   vptree.h
  \brief  Header file for all vptree_*.c files for Vantage Point implementation.
...
typedef struct vptree{
  double * vp; //the coordinates of the vantage point
  ...
  struct vptree* inner; //subtree with points whose distance from vantage point<=md
  struct vptree* outer; //subtree with points whose distance from vantage point>md
}vptree;
